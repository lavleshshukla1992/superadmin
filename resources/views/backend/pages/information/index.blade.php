            ...
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left">
                        ...
                        <li><span>All Information</span></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title float-left">Information List</h4>
                                ...
                                <tbody>
                                    @foreach ($informations as $key=> $information)
                                        <tr>
                                            ...
                                            <td>{{ $information['information_link'] }}</td>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <div class="btn-group mr-2">
                                                        <a href="{{route('information.show',$information['id'])}}" type="btn" class="btn btn-sm btn-outline-secondary pr-2"> 
