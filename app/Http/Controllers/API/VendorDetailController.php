...
class VendorDetailController extends Controller
{
    ...
    {
        $vendors = VendorDetail::leftJoin('roles as r','r.id','=','vendor_details.uid')
        ->leftJoin('memeberships as m','m.user_id','=','vendor_details.uid')
        ->select([
        ...
        // dd($vendors);
        return response()->json(['success' => true,'status_code' =>200 , 'message' => 'Vendor list loaded Successfully','data'=>new VendorDetailCollection($vendors)]) ;
    }
