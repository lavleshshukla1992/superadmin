            ...
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left">
                        ...
                        <li><a href="{{ route('district.index') }}">All District</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['route'=>'district.store','method'=>'post']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="header-title">Manage District</h4>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::select('state_id',App\Models\State::pluck('name','id'), null , ['class'=>'form-control']) !!}
                                    </div>
                                    <div class="col-md-6">
